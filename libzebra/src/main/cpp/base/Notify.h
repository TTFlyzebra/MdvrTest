...
public:
    ...
    virtual void handle(int32_t type, const char* data, int32_t size, int32_t p1, int32_t p2, int32_t p3, int64_t p4, int64_t tid) = 0;
};
...
public:
    ...
    void handledata(NofifyType type, const char* data, int32_t size, int32_t p1, int32_t p2, int32_t p3, int64_t p4, int64_t tid = 0);
