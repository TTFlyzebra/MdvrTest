...
public:
    ...
    static void I420Mirror(const char* src, char* obj, int32_t width, int32_t height);

    static void I420MirrorVertical(const char* src, char* obj, int32_t width, int32_t height);
    ...
    static void BGRAToI420(const char* src, char* obj, int32_t w1, int32_t h1, int32_t w2, int32_t h2);

};

#endif //ANDROID_YUVUTIL_H
